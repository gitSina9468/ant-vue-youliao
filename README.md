...
<h1 align="center">Ant Vue YouLiao</h1>
<div align="center">
此前段项目基于Ant Design Pro Vue脚手架开发;对前段的接入改造将以博客文档形式更新出来;敬请期待!!!
</div>

- 基于目前线上版1.0 打的包 dist.zip  可直接部署在本地前段运行 
- Ant Vue YouLiao 预览: http://132.232.43.102   体验账号  guest  guest
- 后端地址: https://github.com/gitSina9468/youliao
- 有任何问题可 email到 470472264@qq.com

<h2 align="center">Ant Design Pro Vue</h2>
<div align="center">
