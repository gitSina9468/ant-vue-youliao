...
// eslint-disable-next-line
import { BasicLayout, BlankLayout, PageView, RouteView, IframePageView} from '@/layouts'
...
export const generator = (routerMap, parent) => {
  return routerMap.map(item => {
    ...
    if (item.isFrame) {
      currentRouter.path = item.path.substring(item.path.indexOf("/api"))
    }
    // 是否设置了隐藏子菜单
    if (hideChildren) {
