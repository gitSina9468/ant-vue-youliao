      ...
      <a-card :bordered="false">
        <a-form :form="form">
          <a-form-item
            ...
            label="机构名称">
            <a-input placeholder="请输入机构/部门名称" v-decorator="['deptName', validatorRules.departName ]"/>
          </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      batchDel: function () {
        ...
        if (this.checkedKeys.length <= 0) {
          ...
          this.$confirm({
            ...
            onOk: function () {
              httpAction(that.url.deleteBatch, ids,'delete').then((res) => {
                if (res.code == 200) {
      ...
      setValuesToForm(record) {
        ...
        this.form.setFieldsValue(pick(record, 'deptName', 'sort', 'remark'))
      },
